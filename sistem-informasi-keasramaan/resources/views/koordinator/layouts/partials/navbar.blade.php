...
<div class="py-4 text-gray-400 space-y-1">
    <!-- BASIC LINK -->
    <a href="{{ route('koordinator.home') }}" class="py-2.5 px-4 flex items-center space-x-2 bg-gray-800 text-white hover:bg-gray-800 hover:text-white rounded">
    ...
    <div class="block" x-data="{open: false}">
        ...
        <div x-show="open" class="text-sm border-l-2 border-gray-800 mx-6 my-2.5 px-2.5 flex flex-col gap-y-1">
            <a href="{{ route('koordinator.show.data-petugas') }}" class="block py-2 px-4 hover:bg-gray-800 hover:text-white rounded font-poppins">
                Data Petugas
            </a>
            <a href="{{ route('koordinator.show.asrama') }}" class="block py-2 px-4 hover:bg-gray-800 hover:text-white rounded font-poppins">
                Data Asrama
            </a>
