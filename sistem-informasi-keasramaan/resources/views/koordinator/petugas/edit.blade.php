...
@section('judul-halaman')
    <a href="{{ route('koordinator.show.data-petugas') }}"><span class="text-gray-600">Data Petugas / </a></span>Edit
    Petugas Asrama
@endsection
            ...
            focus:border-blue-500 block  px-4 py-2 outline-none rounded-md w-full
                      dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500 font-poppins">
                            ...
                            <option class="font-poppins" value="laki-laki"
                                {{ $petugas->jenis_kelamin == 'laki-laki' ? 'selected' : '' }}">Laki-Laki</option>
                            <option class="font-poppins" value="perempuan"
                                {{ $petugas->jenis_kelamin == 'perempuan' ? 'selected' : '' }}">Perempuan</option>
                    ...
                    text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                        dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500 font-poppins">
                            ...
                            <option class="font-poppins" value="Bapak Asrama"
                                {{ $petugas->jabatan == 'Bapak Asrama' ? 'selected' : '' }}>Bapak Asrama</option>
                            <option class="font-poppins" value="Ibu Asrama"
                                {{ $petugas->jabatan == 'Ibu Asrama' ? 'selected' : '' }}>Ibu Asrama</option>
                            <option class="font-poppins" value="Abang Asrama"
                                {{ $petugas->jabatan == 'Abang Asrama' ? 'selected' : '' }}>Abang Asrama</option>
                            <option class="font-poppins" value="Kakak Asrama"
                                {{ $petugas->jabatan == 'Kakak Asrama' ? 'selected' : '' }}>Kakak Asrama</option>
