...
@section('judul-halaman')
    <a href="{{ route('koordinator.show.data-petugas') }}"><span class="text-gray-600">Data Petugas / </a></span>Tambah
    Petugas Asrama
@endsection
...
@section('table')
    ...
    <div class="h-screen flex justify-start w-full">
        <form action="{{ route('koordinator.store.data-petugas') }}" method="POST">
            @csrf
            ...
            <div class="bg-white px-10 py-7 rounded-xl w-screen shadow-md max-w-lg">
                <div class="space-y-4">
                    <h1 class="text-center text-2xl font-semibold text-gray-600 font-poppins">Tambah Petugas Baru</h1>
                    <div>
                    ...
                    <div>
                        <label for="confirm_password" class="block mb-1 text-gray-600 font-semibold font-poppins">Konfirmasi
                            Password</label>
                    ...
                    <div>
                        <label for="jenis_kelamin" class="block mb-1 text-gray-600 font-semibold font-poppins">Jenis
                            Kelamin</label>
            ...
            focus:border-blue-500 block  px-4 py-2 outline-none rounded-md w-full
                      dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500 font-poppins">
                            ...
                            <option value="Pilih Jenis Kelamin" disabled selected class="font-poppins">Pilih Jenis Kelamin
                            </option>
                            <option class="font-poppins"
                                value="laki-laki {{ old('jenis_kelamin') == 'laki-laki' ? 'selected' : '' }}">Laki-Laki
                            </option>
                            <option class="font-poppins"
                                value="perempuan {{ old('jenis_kelamin') == 'perempuan' ? 'selected' : '' }}">Perempuan
                            </option>
                  ...
                  @endforeach --}}
                    ...
                    text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                        dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500 font-poppins">
                            ...
                            <option class="font-poppins" value="Bapak Asrama"
                                {{ old('jabatan') == 'Bapak Asrama' ? 'selected' : '' }}>Bapak Asrama</option>
                            <option class="font-poppins" value="Ibu Asrama"
                                {{ old('jabatan') == 'Ibu Asrama' ? 'selected' : '' }}>Ibu Asrama</option>
                            <option class="font-poppins" value="Abang Asrama"
                                {{ old('jabatan') == 'Abang Asrama' ? 'selected' : '' }}>Abang Asrama</option>
                            <option class="font-poppins" value="Kakak Asrama"
                                {{ old('jabatan') == 'Kakak Asrama' ? 'selected' : '' }}>Kakak Asrama</option>
                    ...
                    <div>
                        <label for="lokasi_bertugas" class="block mb-1 text-gray-600 font-semibold font-poppins">Lokasi
                            Bertugas</label>
                        <select name="lokasi_bertugas" id="asrama"
                            class="bg-indigo-50 border 
                            text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                            dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500 font-poppins">
                            <option class="font-poppins" value="Pilih Lokasi Bertugas" disabled selected>Pilih Lokasi
                                Bertugas</option>

                            @foreach ($dataAsrama as $data)
                                <option value="{{ $data->id }}" class="font-poppins">{{ $data->nama_asrama }}
                                </option>
                            @endforeach
