...
@section('judul-halaman')
    <a href="{{ route('koordinator.show.data-petugas') }}"><span class="text-gray-600">Data Petugas / </a></span>Tambah Petugas Asrama
@endsection
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            focus:border-blue-500 block  px-4 py-2 outline-none rounded-md w-full
                      ...
                      <option class="font-poppins" value="laki-laki {{ old('jenis_kelamin') == "laki-laki" ? "selected" : "" }}">Laki-Laki</option>
                      <option class="font-poppins" value="perempuan {{ old('jenis_kelamin') == "perempuan" ? "selected" : "" }}">Perempuan</option>
          ...
          <div>
            ...
            <select name="jabatan" id="jabatan"  class="bg-indigo-50 border 
                ...
                <option class="font-poppins" value="Bapak Asrama" {{ old('jabatan') == "Bapak Asrama" ? "selected" : ""}}>Bapak Asrama</option>
                <option class="font-poppins" value="Ibu Asrama" {{ old('jabatan') == "Ibu Asrama" ? "selected" : ""}}>Ibu Asrama</option>
                <option class="font-poppins" value="Abang Asrama" {{ old('jabatan') == "Abang Asrama" ? "selected" : ""}}>Abang Asrama</option>
                <option class="font-poppins" value="Kakak Asrama" {{ old('jabatan') == "Kakak Asrama" ? "selected" : ""}}>Kakak Asrama</option>
