...
@section('judul-halaman')
    <a href="{{ route('mahasiswa.izin-bermalam') }}"><span class="text-gray-600">Izin Bermalam / </a></span>Request Izin
    Bermalam
@endsection
        ...
        <form action="{{ route('mahasiswa.store.izin-bermalam') }}" method="POST">
            ...
            <div class="bg-white px-10 py-7 rounded-xl w-screen shadow-md max-w-lg">
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="rencana_berangkat" class="block mb-1 text-gray-600 font-semibold font-poppins">Rencana
                            berangkat</label>
                        <input type="datetime-local" name="rencana_berangkat"
                    ...
                    <div>
                        <label for="rencana_kembali" class="block mb-1 text-gray-600 font-semibold font-poppins">Rencana
                            kembali</label>
                        <input type="datetime-local" name="rencana_kembali"
                            class="bg-indigo-50 px-4 py-2 outline-none rounded-md w-full font-poppins"
                    ...
                    <div>
                        <label for="keperluan_ib" class="block mb-1 text-gray-600 font-semibold font-poppins">Keperluan
                            IB</label>
                        <textarea name="keperluan_ib" id="keperluan_ib" rows="4"
            ...
            w-full font-poppins"></textarea>
                    ...
                    <div>
                        <label for="tempat_tujuan" class="block mb-1 text-gray-600 font-semibold font-poppins">Tempat
                            Tujuan</label>
