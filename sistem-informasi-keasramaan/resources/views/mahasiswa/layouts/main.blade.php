            ...
            <div class="flex flex-col justify-between h-full">
                ...
                <div class="text-gray-200 border-gray-800 rounded flex items-center justify-between p-2">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <h1 class="text-sm font-poppins">{{ Auth::guard('web')->user()->nama }}</h1>
                    </div>
                    </a>
                    <a onclick="event.preventDefault(); document.getElementById('logoutForm').submit()" href="{{ route('mahasiswa.logout') }}" class="hover:bg-gray-800 hover:text-white p-2 rounded">
                        <form id="logoutForm" action="{{ route('mahasiswa.logout') }}" method="POST">
                            @csrf 
