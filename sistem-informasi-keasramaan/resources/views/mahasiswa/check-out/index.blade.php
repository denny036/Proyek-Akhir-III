...
@section('table')
    ...
    <a href="{{ route('mahasiswa.request.check-out') }}">
        <button type="button"
    ...
    dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 font-poppins disabled:opacity-75" disabled >Request Check Out</button>
    </a>
    <p class="text-red-600 font-base font-poppins">*Anda tidak dapat melakukan check out jika terdapat request <span class="font-semibold">Menunggu.</span></p>
    @else
    <a href="{{ route('mahasiswa.request.check-out') }}">
        <button type="button"
            class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 
    ...
    <div class="bg-white shadow rounded-sm my-2.5 overflow-x-auto">
        ...
        <table class="min-w-max w-full table-auto">
            ...
            @foreach ($riwayatCheckOut as $key => $data)
                <tbody class="text-gray-600 text-sm">
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center font-poppins">
                            {{ \Carbon\Carbon::parse($data->tanggal_check_out)->isoFormat('DD MMMM YYYY H:mm') }}
                        </td>
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                                <span class="bg-blue-500 text-slate-50 py-1 px-3 rounded-full text-xs font-poppins">
                                    <a href="{{ route('mahasiswa.detail.check-out', $data->id) }}">Detail</a>
                                </span>
                            </div>
                        </td>
                    </tr>
    ...
    <div class="row">
        <div class="col-md-12">
            {{ $riwayatCheckOut->links('pagination::tailwind') }}
        </div>
    </div>
