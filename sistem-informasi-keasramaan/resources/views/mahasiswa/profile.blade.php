      ...
      <div class="relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
        <div class="max-w-md mx-auto">
          ...
          <div class="flex items-center space-x-5">
            <div class="h-14 w-14 bg-blue-500 rounded-full flex flex-shrink-0 justify-center items-center text-neutral-50 text-2xl font-mono">i</div>
            ...
            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              <div class="flex flex-col">
                ...
                dark:bg-gray-200 dark:border-gray-600 dark:placeholder-gray-400 
                        ...
                        <option class="font-poppins" value="Pilih Asrama" disabled selected>Pilih Asrama</option>
...
@else
  ...
  <div class="bg-gray-100 block py-10">
    <div class="max-w-2xl justify-start">
      ...
      <div
        class="bg-primary border border-primary rounded-b-lg p-5 pt-4 flex flex-col"
      >
